...
(async () => {
  ...
  const pages = [
    { url: 'http://localhost:52813/dashboard', name: '03_dashboard_cabinets_v2.png', label: '대시보드 (캐비넷)', tab: null },
    { url: 'http://localhost:52813/layout-editor', name: '04_layout_editor_v2.png', label: 'LayoutEditor', tab: null },
  ];
